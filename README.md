...
```text
├── analise_vendas_ecommerce.ipynb # Jupyter Notebook com a análise completa e gráficos
...
4. **Abra o arquivo:**
   No navegador que abrir automaticamente, clique em `analise_vendas_ecommerce.ipynb` e execute as células sequencialmente (`Shift + Enter` ou vá em **Kernel > Restart & Run All**).
