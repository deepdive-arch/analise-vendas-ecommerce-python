...
!\[Jupyter](https://img.shields.io/badge/Jupyter\_Notebook-F37626?style=for-the-badge\&logo=jupyter\&logoColor=white)
...
```text
├── analise\_vendas\_ecommerce.ipynb   # Jupyter Notebook com a análise completa e gráficos
...
4. **Abra o arquivo:**
No navegador que abrir automaticamente, clique em `mini\_projeto\_1\_vendas.ipynb` e execute as células sequencialmente (`Shift + Enter` ou vá em **Kernel > Restart \& Run All**).
